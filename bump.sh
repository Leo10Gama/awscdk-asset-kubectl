...
# git clean -fqdx .  # TEMP COMMENT: uncomment when ready to raise real commit

# Install dependencies
yarn install --frozen-lockfile

# Make a new branch and clean it
git checkout -b kubectl-v${1}TEMP/main kubectl-v$PREV_KUBECTL_VERSION/main  # TODO: remove TEMP when ready to raise real commit
...
git push origin kubectl-v${1}TEMP/main
echo "Please visit the link above and open your pull request. Ensure the PR passes all stages of execution and all tests pass. Please also ensure one other engineer approves of the changes before merging in."
echo "Thank you for your contribution!"

# TEMP cleanup for testing purposes, remove when done
read -p "Press Enter to continue..."
git stash
git checkout kubectl-v$PREV_KUBECTL_VERSION/main
git branch -D kubectl-v${1}TEMP/main